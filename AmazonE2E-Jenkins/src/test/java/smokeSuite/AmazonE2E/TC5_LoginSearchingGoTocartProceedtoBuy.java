...
public class TC5_LoginSearchingGoTocartProceedtoBuy extends BaseTest
{
	@Test(retryAnalyzer=RetryLogic.class)
	public void logintoGotocart() throws InterruptedException
	{
		Reporter.log("Browser launched successfully");
		   ...
		   Assert.assertEquals(cartdetailspage.verifytheTextShoppingcart(), "Shopping Cart","Sorry conditions did not match");
